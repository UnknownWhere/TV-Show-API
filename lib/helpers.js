							...
							trakt.season(imdb,season,{extended:'full,images'}, function(err, seasonData) {
								for (var episodeData in seasonData) {
									...
									if (typeof(data[season]) != 'undefined' && typeof(data[season][episodeData.episode]) != 'undefined') {
										...
										thisEpisode.torrents[0] = data[season][episodeData.number]["480p"] ? data[season][episodeData.episode]["480p"] : data[season][episodeData.episode]["720p"]; // Prevents breaking the app
