...
module.exports = {
  ...
  getPage: function(req, res) {
    ...
    if (req.params.page == 'all') {
      ...
      // paging
      Show.find(query,{ _id: 1, imdb_id: 1, tvdb_id:1, title:1, year:1,synopsis:1,rating:1,trailer:1, images:1, slug:1, num_seasons:1, last_updated:1, ratings:1 }).sort(sort).skip(offset).limit(config.pageSize).exec(function (err, docs) {
        res.json(docs);
      });
